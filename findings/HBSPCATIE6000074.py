...
class Finding:
    ...
    def get_rule_title(self):
        return r"The Don?t prompt for client certificate selection when no certificate or only one certificate exists is not set properly for the Restricted Sites Zone."

    def get_vulnerability_discussion(self):
        return r"Client certificates should not be presented to web sites without the user''s acknowledgement. Manipulate the registry key HKCU\Software\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\4Criteria: If the value 1A04 is REG_DWORD=3 (Disabled)."
    ...
    def check(self, cli):
        ...
        # Output Lines
        self.__output = [r'HKCU:\Software\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\4', ('1A04=' + str(dword))]
