...
class Finding:
    ...
    def get_rule_title(self):
        return r"Services using Local System that use Negotiate when reverting to NTLM authentication must use the computer identity vs. authenticating anonymously."

    def get_vulnerability_discussion(self):
        return r"Services using Local System that use Negotiate when reverting to NTLM authentication may gain unauthorized access if allowed to authenticate anonymously vs. using the computer identity. Set the policy value for Computer Configuration \ Windows Settings \ Security Settings \ Local Policies \ Security Options \ ''Network security: Allow Local System to use computer identity for NTLM'' to ''Enabled''."
