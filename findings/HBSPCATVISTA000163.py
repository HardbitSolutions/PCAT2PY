...
class Finding:
    ...
    def get_rule_title(self):
        return r"Meeting Space"

    def get_vulnerability_discussion(self):
        return r"This check verifies that Windows Meeting Space is disabled. Vista - Set the policy value for Computer Configuration \ Administrative Templates \ Windows Components \ Windows Meeting Space ?Turn off Windows Meeting Space? to ?Enabled?"
    ...
    def check(self, cli):
        ...
        # Output Lines
        self.__output = [r'HKLM:\Software\Policies\Microsoft\Windows\Windows Collaboration', ('TurnOffWindowsCollaboration=' + str(dword))]
