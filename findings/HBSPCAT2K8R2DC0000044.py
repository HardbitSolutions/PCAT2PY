...
class Finding:
    ...
    def get_rule_title(self):
        return r"The print driver installation privilege will be restricted to administrators."

    def get_vulnerability_discussion(self):
        return r"Allowing users to install drivers can introduce malware or cause the instability of a system.  This capability should be restricted to the Administrators and Print Operators groups. Set the policy value for Computer Configuration \ Windows Settings \ Security Settings \ Local Policies \ Security Options \ ?Devices: Prevent users from installing printer drivers? to ?Enabled?."
