...
class Finding:
    ...
    def get_rule_title(self):
        return "Users must not be able to change passwords more than once every 24 hours."
    
    def get_vulnerability_discussion(self):
        return "Setting the minimum password age protects against users cycling back to a favorite password after satisfying the password reuse requirement."
