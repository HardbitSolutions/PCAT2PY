...
class Finding:
    ...
    def get_vulnerability_discussion(self):
        return r"Inadequate log size will cause the log to fill up quickly and require frequent clearing by administrative personnel. If the system is not configured to write directly to an audit server, Set the policy value for Computer Configuration \ Administrative Templates \ Windows Components \ Event Log Service \ System \ ''Specify the maximum log size (KB)'' to at minimum ''Enabled:32768''."
