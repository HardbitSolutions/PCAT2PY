...
class Finding:
    ...
    def get_rule_title(self):
        return r"Unauthorized accounts must not have the Allow log on through Remote Desktop Services user right."

    def get_vulnerability_discussion(self):
        return r"Inappropriate granting of user rights can provide system, administrative, and other high-level capabilities.Accounts with the ''Allow log on through Remote Desktop Services'' user right can access a system through Remote Desktop. Set the policy value for Computer Configuration \ Windows Settings \ Security Settings \ Local Policies \ User Rights Assignment \ ''Allow log on through Remote Desktop Services'' to only include the following accounts or groups:Administrators"
