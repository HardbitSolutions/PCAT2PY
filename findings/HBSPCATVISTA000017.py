...
class Finding:
    ...
    def get_rule_title(self):
        return r"System halts once an event log has reached its maximum size."

    def get_vulnerability_discussion(self):
        return r"This check verifies that the system will not halt if the audit logs become full. Set the policy value for Computer Configuration \ Windows Settings \ Security Settings \ Local Policies \ Security Options \ ?Audit: Shut down system immediately if unable to log security audits? to ?Disabled?."
