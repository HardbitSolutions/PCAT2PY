...
class Finding:
    ...
    def get_rule_title(self):
        return r"The 6to4 IPv6 transition technology must be disabled."

    def get_vulnerability_discussion(self):
        return r"IPv6 transition technologies, which tunnel packets through other protocols, do not provide visibility. Set the policy value for Computer Configuration \ Administrative Templates \ Network \ TCPIP Settings \ IPv6 Transition Technologies \ ''Set 6to4 State'' to ''Enabled: Disabled State''."
    ...
    def check(self, cli):
        ...
        # Output Lines
        self.__output = [r'HKLM:\Software\Policies\Microsoft\Windows\TCPIP\v6Transition', ('6to4_State=' + sz)]
