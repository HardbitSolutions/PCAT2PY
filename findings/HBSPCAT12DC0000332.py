...
class Finding:
    ...
    def get_rule_title(self):
        return r"Media Player must be configured to prevent automatic Codec downloads."
    ...
    def check(self, cli):
        ...
        # Output Lines
        self.__output = [r'HKCU:\Software\Policies\Microsoft\WindowsMediaPlayer', ('PreventCodecDownload=' + str(dword))]
