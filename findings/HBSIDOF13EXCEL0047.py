...
class Finding:
    ...
    def get_rule_title(self):
        return r"Corrupt workbook options must be disallowed."

    def get_vulnerability_discussion(self):
        return r"This setting controls whether Excel presents users with a list of data extraction options before beginning an Open and Repair operation when users choose to open a corrupt workbook in repair or extract mode. A corrupt Excel file may be indicative of malicious tampering. By allowing the automatic handling of corrupt spreadsheets, malicious code may be introduced to the user''s computer and the network. Set the policy value for: User Configuration \ Administrative Templates \ Microsoft Excel 2013 \ Data Recovery \ ''Do not show data extraction options when opening corrupt workbooks'' to ''Enabled''."
    ...
    def check(self, cli):
        ...
        # Output Lines
        self.__output = [r'HKCU:\software\policies\microsoft\office\15.0\excel\options', ('extractdatadisableui=' + str(dword))]
