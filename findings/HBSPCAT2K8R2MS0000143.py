...
class Finding:
    ...
    def get_rule_title(self):
        return r"Users will be prevented from sharing files in their profiles."

    def get_vulnerability_discussion(self):
        return r"This check verifies that users are prevented from sharing files. Note: This setting is under USER Configuration, not COMPUTER Configuration.Set the policy value for User Configuration \ Administrative Templates \ Windows Components \ Network Sharing ?Prevent users from sharing files within their profile? to ?Enabled?."
