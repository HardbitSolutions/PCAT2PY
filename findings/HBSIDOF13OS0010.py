...
class Finding:
    ...
    def get_rule_title(self):
        return r"The encryption type for password protected Open XML files must be set."

    def get_vulnerability_discussion(self):
        return r"If unencrypted files are intercepted, sensitive information in the files can be compromised. To protect information confidentiality, Microsoft Office application files can be encrypted and password protected. Only users who know the correct password will be able to decrypt such files. Since some encryption types are less secure and easier to breach, Microsoft Enhanced RSA and AES Cryptographic Provider, AES-256, 256-bit should be used when encrypting documents. Set the policy value for: User Configuration \ Administrative Templates \ Microsoft Office 2013 \ Security Settings ''Encryption type for password protected Office Open XML files'' to ''Enabled (Microsoft Enhanced RSA and AES Cryptographic Provider, AES-256, 256-bit)''."
    ...
    def check(self, cli):
        ...
        # Output Lines
        self.__output = [r'HKCU:\Software\Policies\Microsoft\Office\15.0\common\security', ('OpenXMLEncryption=' + sz)]
