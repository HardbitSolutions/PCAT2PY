...
class Finding:
    ...
    def get_rule_title(self):
        return r"Unauthorized accounts will not have the ''Create global objects'' user right."

    def get_vulnerability_discussion(self):
        return r"Inappropriate granting of user rights can provide system, administrative, and other high level capabilities.Accounts with the ''Create global objects'' right can create objects that are available to all sessions which could affect processes in other users'' sessions. Set the policy value for Computer Configuration \ Windows Settings \ Security Settings \ Local Policies \ User Rights Assignment \ ''Create global objects'' as defined."
