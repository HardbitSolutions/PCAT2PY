...
class Finding:
    ...
    def get_vulnerability_discussion(self):
        return r"Check for publisher''s certificate revocation options should be enforced to ensure all PKI signed objects are validated. Check mark the option to enable ''Check for publisher''s certificate revocation'' in the Internet Explorer Options, Advanced page. NOTE: Manual entry for the value State, set to REG_DWORD = 65536, may first be required."
