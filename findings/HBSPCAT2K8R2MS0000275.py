...
class Finding:
    ...
    def get_rule_title(self):
        return r"Anonymous SID/Name translation will not be allowed."

    def get_vulnerability_discussion(self):
        return r"This is a high priority finding because this setting controls the ability of users or process that have authenticated as anonymous users to perform SID/Name translation.  This setting should be disabled, as only authorized users should be able to perform such translations. Set the policy value for Computer Configuration \ Windows Settings \ Security Settings \ Local Policies \ Security Options \ ?Network access: Allow anonymous SID/Name translation? to ?Disabled?."
