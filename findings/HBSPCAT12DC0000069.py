...
class Finding:
    ...
    def get_rule_title(self):
        return r"The system must require username and password to elevate a running application."

    def get_vulnerability_discussion(self):
        return r"Enumeration of administrator accounts when elevating can provide part of the logon information to an unauthorized user.  This setting configures the system to always require users to type in a username and password to elevate a running application. Set the policy value for Computer Configuration \ Administrative Templates \ Windows Components \ Credential User Interface \ ''Enumerate administrator accounts on elevation'' to ''Disabled''."
