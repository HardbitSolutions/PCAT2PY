...
class Finding:
    ...
    def get_rule_title(self):
        return r"Prevent NTLM from falling back to a null session."

    def get_vulnerability_discussion(self):
        return r"This setting prevents NTLM from falling back to a null (unauthenticated) session. Set the policy value for ?Network Security: Allow LocalSystem null session fallback? to ?Disabled?."
