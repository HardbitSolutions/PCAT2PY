...
class Finding:
    ...
    def get_rule_title(self):
        return r"Error Reporting events will be logged in the system event log."

    def get_vulnerability_discussion(self):
        return r"This check verifies that Error Reporting events will be logged in the system event log. Set the policy value for Computer Configuration \ Administrative Templates \ Windows Components \ Windows Error Reporting ?Disable Logging? to ?Disabled?."
