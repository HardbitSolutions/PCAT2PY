...
class Finding:
    ...
    def get_rule_title(self):
        return r"Block pop-ups for links that invoke instances of IE from within InfoPath."
    ...
    def check(self, cli):
        ...
        # Output Lines
        self.__output = [r'HKLM:\Software\Microsoft\Internet Explorer\Main\FeatureControl\FEATURE_WEBOC_POPUPMANAGEMENT', ('spDesign.exe=' + str(dword))]
