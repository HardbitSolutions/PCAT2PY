...
class Finding:
    ...
    def get_rule_title(self):
        return r"The system is not configured to recommended LDAP client signing requirements."

    def get_vulnerability_discussion(self):
        return r"This setting controls the signing requirements for LDAP clients.  This setting should be set to Negotiate signing or Require signing depending on the environment and type of LDAP server in use. Set the policy value for Computer Configuration \ Windows Settings \ Security Settings \ Local Policies \ Security Options \ ?Network security: LDAP client signing requirements? to ?Negotiate signing? at a minimum."
