...
class Finding:
    ...
    def get_rule_title(self):
        return r"A screen saver must be enabled on the system."

    def get_vulnerability_discussion(self):
        return r"Unattended systems are susceptible to unauthorized use and must be locked when unattended.  Enabling a password-protected screen saver to engage after a specified period of time helps protects critical and sensitive data from exposure to unauthorized personnel with physical access to the computer. Set the policy value for User Configuration \ Administrative Templates \ Control Panel \ Personalization \ ''Enable screen saver'' to ''Enabled''."
