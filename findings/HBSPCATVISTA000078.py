...
class Finding:
    ...
    def get_rule_title(self):
        return r"Hide Computer from the browse list."

    def get_vulnerability_discussion(self):
        return r"This check verifies Windows Vista is configured to hide the computer from the browse list. Set the policy value for Computer Configuration \ Windows Settings \ Security Settings \ Local Policies \ Security Options \ ?MSS: (Hidden) Hide Computer From the Browse List? to ?Enabled?."
