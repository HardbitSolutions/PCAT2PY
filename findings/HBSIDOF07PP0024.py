...
class Finding:
    ...
    def check(self, cli):
        ...
        # Output Lines
        self.__output = [r'HKCU:\Software\Policies\Microsoft\Office\12.0\PowerPoint\Options', ('MarkupOpenSave=' + str(dword))]
