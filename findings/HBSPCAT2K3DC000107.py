...
class Finding:
    ...
    def get_rule_title(self):
        return r"The Deny log on through Terminal Services user right on domain controllers must prevent all access if TS is not used by the organization.  If TS is used, it must be configured to prevent unauthenticated access."
