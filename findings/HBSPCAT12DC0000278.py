...
class Finding:
    ...
    def get_rule_title(self):
        return r"The Application event log must be configured to a minimum size requirement."

    def get_vulnerability_discussion(self):
        return r"Inadequate log size will cause the log to fill up quickly and require frequent clearing by administrative personnel. Set the policy value for Computer Configuration \ Administrative Templates \ Windows Components \ Event Log Service \ Application \ ''Specify the maximum log size (KB)'' to at minimum ''Enabled:32768''."
