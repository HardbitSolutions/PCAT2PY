...
class Finding:
    ...
    def get_rule_title(self):
        return r"Disable Help Ratings feed back."

    def get_vulnerability_discussion(self):
        return r"This check verifies that the users cannot provide ratings feedback to Microsoft for Help content Set the policy value for User Configuration \ Administrative Templates \ System \ Internet Communication Management \ Internet Communication Settings \ ?Turn off Help Ratings? to ?Enabled?."
