...
class Finding:
    ...
    def get_rule_title(self):
        return r"Windows Update must be prevented from searching for point and print drivers."

    def get_vulnerability_discussion(self):
        return r"Some features may communicate with the vendor, sending system information or downloading data or components for the feature.  Turning off this capability will prevent potentially sensitive information from being sent outside the enterprise and uncontrolled updates to the system.  This setting will prevent Windows from searching Windows Update for point and print drivers.  Only the local driver store and server driver cache will be searched. Set the policy value for Computer Configuration \ Administrative Templates \ Printers \ ''Extend Point and Print connection to search Windows Update'' to ''Disabled''."
