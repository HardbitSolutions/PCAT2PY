...
class Finding:
    ...
    def get_rule_title(self):
        return r"Copying of user input methods to the system account for sign-in must be prevented."

    def get_vulnerability_discussion(self):
        return r"Allowing different input methods for sign-in could open different avenues of attack.  User input methods must be restricted to those enabled for the system account at sign-in. Set the policy value for Computer Configuration \ Administrative Templates \ System \ Locale Services \ ''Disallow copying of user input methods to the system account for sign-in'' to ''Enabled''."
    ...
    def check(self, cli):
        ...
        # Output Lines
        self.__output = [r'HKLM:\Software\Policies\Microsoft\Control Panel\International', ('BlockUserInputMethodsForSignIn=' + str(dword))]
