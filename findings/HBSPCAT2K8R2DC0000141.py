...
class Finding:
    ...
    def get_rule_title(self):
        return r"Remote Assistance log files will be generated."

    def get_vulnerability_discussion(self):
        return r"This check verifies that Remote Assistance log files will be generated. Set the policy value for Computer Configuration \ Administrative Templates \ System \ Remote Assistance ?Turn on session logging? to ?Enabled?."
