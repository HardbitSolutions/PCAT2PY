...
class Finding:
    ...
    def get_rule_title(self):
        return r"Device Install ? Drivers System Restore Point"

    def get_vulnerability_discussion(self):
        return r"This check verifies that a system restore point will be created when a new device driver is installed. Vista - Set the policy value for Computer Configuration \ Administrative Templates \ System \ Device Installation ?Do not create a system restore point when new device driver installed? to ?Disabled?."
