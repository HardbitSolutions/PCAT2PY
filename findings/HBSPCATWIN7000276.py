...
class Finding:
    ...
    def get_rule_title(self):
        return r"Unauthorized registry paths are remotely accessible."

    def get_vulnerability_discussion(self):
        return r"This setting controls which registry paths are accessible from a remote computer.  This is a high priority finding because it could give unauthorized individuals access to the registry. Set the policy value for Computer Configuration \ Windows Settings \ Security Settings \ Local Policies \ Security Options \ ?Network access: Remotely accessible registry paths? as defined."
