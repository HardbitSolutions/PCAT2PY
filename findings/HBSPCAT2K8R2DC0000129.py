...
class Finding:
    ...
    def get_rule_title(self):
        return r"The configuration of wireless devices using Windows Connect Now will be disabled."
    ...
    def check(self, cli):
        ...
        # Output Lines
        self.__output = [r'HKLM:\Software\Policies\Microsoft\Windows\WCN\Registrars', ('DisableInBand802DOT11Registrar=' + str(dword))]
