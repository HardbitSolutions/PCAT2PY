...
class Finding:
    ...
    def get_rule_title(self):
        return r"Configure Outlook Dial-up options to Warn user before allowing switch in dial-up access."
    ...
    def check(self, cli):
        ...
        # Output Lines
        self.__output = [r'HKCU:\Software\Policies\Microsoft\Office\12.0\Outlook\Options\Mail', ('Warn on Dialup=' + str(dword))]
