...
class Finding:
    ...
    def get_vulnerability_discussion(self):
        return r"If unencrypted files are intercepted, sensitive information in the files can be compromised. To protect information confidentiality, Microsoft Office application files can be encrypted and password protected. Only users who know the correct password will be able to decrypt such files. Set the policy value for: User Configuration \ Administrative Templates \ Microsoft Office 2010 \ Security Settings ?Encryption type for password protected Office 97-2003 files? to ?Enabled (Microsoft Enhanced RSA and AES Cryptographic Provider,AES 256,256)?."
    ...
    def check(self, cli):
        ...
        # Output Lines
        self.__output = [r'HKCU:\Software\Policies\Microsoft\Office\14.0\common\security', ('DefaultEncryption12=' + sz)]
