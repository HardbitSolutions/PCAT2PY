...
class Finding:
    ...
    def get_rule_title(self):
        return r"InfoPath 2003 forms as email forms in InfoPath 2010 must be disallowed."

    def get_vulnerability_discussion(self):
        return r"An attacker might target InfoPath 2003 forms to try and compromise an organization''s security. InfoPath 2003 did not write a published location for e-mail forms, which means forms could open without a corresponding published location.By default, InfoPath sends all forms via e-mail using InfoPath e-mail forms integration, including forms created using the InfoPath 2003 file format. Set the policy value for: User Configuration \ Administrative Templates \ Microsoft InfoPath 2010 \ InfoPath e-mail forms ?Disable sending InfoPath 2003 Forms as e-mail forms? to ?Enabled?."
    ...
    def check(self, cli):
        ...
        # Output Lines
        self.__output = [r'HKCU:\Software\Policies\Microsoft\Office\14.0\infopath', ('DisableInfoPath2003EmailForms=' + str(dword))]
