...
class Finding:
    ...
    def get_rule_title(self):
        return r"Enable the feature to warn before printing that the document contains tracking changes. - Word"

    def get_vulnerability_discussion(self):
        return r"Warn before printing, saving or sending a file that contains tracked changes or comments. Set the policy value for: User Configuration \ Administrative Templates \ Microsoft Office Word 2007 \ Word Options \ Security ?Warn before printing, saving or sending a file that contains tracked changes or comments? will be set to ?Enabled?."
    ...
    def check(self, cli):
        ...
        # Output Lines
        self.__output = [r'HKCU:\Software\Policies\Microsoft\Office\12.0\Word\Options\vpref', ('fWarnRevisions_1805_1=' + str(dword))]
