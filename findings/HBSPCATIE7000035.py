...
class Finding:
    ...
    def get_rule_title(self):
        return r"Navigate sub-frames across different domains for restricted sites zone are not disabled."

    def get_vulnerability_discussion(self):
        return r"Frames that navigate across different domains are a security concern because the user may think they are accessing pages on one site while they are actually accessing pages on another site. Manipulate the value: HKLM\Software\Policies\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\4Criteria: Set the value 1607 to REG_DWORD = 3."
