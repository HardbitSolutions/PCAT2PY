...
class Finding:
    ...
    def get_rule_title(self):
        return r"The Font download control is not set properly for the Restricted Sites Zone."

    def get_vulnerability_discussion(self):
        return r"Download of fonts can sometimes contain malicious code.    Files should not be downloaded from restricted sites. Manipulate the registry key to read as follows: HKLM:\Software\Policies\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\4 Criteria: Set the value 1604 to REG_DWORD = 3 (Disabled = 3)."
    ...
    def check(self, cli):
        ...
        # Output Lines
        self.__output = [r'HKLM:\Software\Policies\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\4', ('1604=' + str(dword))]
