...
class Finding:
    ...
    def get_rule_title(self):
        return r"Internet Explorer Processes for MIME sniffing must be enforced (Reserved)."
    ...
    def check(self, cli):
        ...
        # Output Lines
        self.__output = [r'HKLM:\Software\Policies\Microsoft\Internet Explorer\Main\FeatureControl\FEATURE_MIME_SNIFFING', ('(Reserved)=' + sz)]
