...
class Finding:
    ...
    def get_rule_title(self):
        return "The system must not permit root logins using remote access programs such as ssh."
    
    def get_vulnerability_discussion(self):
        return "Permitting direct root login reduces auditable information about who ran privileged commands on the system and also allows direct attack attempts on root's password."
