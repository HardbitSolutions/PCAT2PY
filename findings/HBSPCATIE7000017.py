...
class Finding:
    ...
    def get_rule_title(self):
        return r"Userdata persistence for internet zone is not disabled."

    def get_vulnerability_discussion(self):
        return r"Userdata persistence must have level of protection based upon the site being accessed. Manipulate the value: HKLM\Software\Policies\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\3Criteria: Set the value 1606 to REG_DWORD = 3."
