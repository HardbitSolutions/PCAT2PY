...
class Finding:
    ...
    def get_vulnerability_discussion(self):
        return r"The Microsoft Office Compatibility Pack for Excel 2010 File Formats installed can open Office Open XML files saved with pre-release versions of Excel 2010. Excel Open XML files usually have the following extensions: .xlsx, .xlsm, .xltx, .xltm, .xlam. Set the policy value for: User Configuration \ Administrative Templates \ Microsoft Office 2010 \ Office 2010 Converters ?Block opening of pre-release versions of file formats new to Excel 2010 through the Compatibility Pack for Office 2010 and Excel 2010 Converter? to ?Enabled?."
    ...
    def check(self, cli):
        ...
        # Output Lines
        self.__output = [r'HKCU:\Software\Policies\Microsoft\Office\14.0\excel\security\fileblock', ('Excel12BetaFilesFromConverters=' + str(dword))]
