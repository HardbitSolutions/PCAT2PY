...
class Finding:
    ...
    def get_rule_title(self):
        return r"Unauthorized shares can be accessed anonymously."

    def get_vulnerability_discussion(self):
        return r"This is a high priority finding because of the potential for gaining unauthorized system access. Any shares listed can be accessed by any network user.  This could lead to the exposure or corruption of sensitive data. Set the policy value for Computer Configuration \ Windows Settings \ Security Settings \ Local Policies \ Security Options \ ?Network access: Shares that can be accessed anonymously? to be defined but containing no entries (Blank)."
