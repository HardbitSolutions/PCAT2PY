...
class Finding:
    ...
    def get_rule_title(self):
        return r"Check for publishers certificate revocation is enforced."

    def get_vulnerability_discussion(self):
        return r"Check for publisher''s certificate revocation options should be enforced to ensure all PKI signed objects are validated. Manipulate the registry keyHKEY_CURRENT_USER\Software\Microsoft\CurrentVersion\WinTrust\Trust Providers\Software Publishing to 65536."
