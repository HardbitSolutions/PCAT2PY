...
class Finding:
    ...
    def get_rule_title(self):
        return r"Domain controllers must be configured to allow reset of machine account passwords."

    def get_vulnerability_discussion(self):
        return r"Enabling this setting on all domain controllers in a domain prevents domain members from changing their computer account passwords.  If these passwords are weak or compromised, the inability to change them may leave these computers vulnerable. Set the policy value for Computer Configuration \ Windows Settings \ Security Settings \ Local Policies \ Security Options \ ''Domain controller: Refuse machine account password changes'' to ''Disabled''."
