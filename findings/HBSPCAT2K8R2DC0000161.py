...
class Finding:
    ...
    def get_rule_title(self):
        return r"The Windows Customer Experience Improvement Program will be disabled."

    def get_vulnerability_discussion(self):
        return r"This check verifies that the Windows Customer Experience Improvement Program is disabled so information is not passed to the vendor. Set the policy value for Computer Configuration \ Administrative Templates \ System \ Internet Communication Management \ Internet Communication Settings \ ?Turn off Windows Customer Experience Improvement Program? to ?Enabled?."
    ...
    def check(self, cli):
        ...
        # Output Lines
        self.__output = [r'HKLM:\Software\Policies\Microsoft\SQMClient\Windows', ('CEIPEnable=' + str(dword))]
