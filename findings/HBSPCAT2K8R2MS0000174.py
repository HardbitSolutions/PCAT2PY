...
class Finding:
    ...
    def get_rule_title(self):
        return r"Autoplay will be turned off for non-volume devices."

    def get_vulnerability_discussion(self):
        return r"This setting will disable autoplay for non-volume devices (such as Media Transfer Protocol (MTP) devices). Set the policy value for Computer Configuration \ Administrative Templates \ Windows Components \ AutoPlay Policies \ ?Turn off Autoplay for non-volume devices? to ?Enabled?."
