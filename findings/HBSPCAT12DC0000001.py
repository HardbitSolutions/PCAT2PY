...
class Finding:
    ...
    def get_vulnerability_discussion(self):
        return r"Inadequate physical protection can undermine all other security precautions utilized to protect the system.  This can jeopardize the confidentiality, availability, and integrity of the system.  Physical security is the first line of protection of any system. Ensure servers are located in secure, access-controlled areas."
