...
class Finding:
    ...
    def get_rule_title(self):
        return r"Unauthorized accounts will not have the ''Force shutdown from a remote system'' user right."

    def get_vulnerability_discussion(self):
        return r"Inappropriate granting of user rights can provide system, administrative, and other high level capabilities.Accounts with the ''Force shutdown from a remote system'' right can remotely shut down a system which could result in a DoS. Set the policy value for Computer Configuration \ Windows Settings \ Security Settings \ Local Policies \ User Rights Assignment \ ''Force shutdown from a remote system'' as defined."
    ...
    def check(self, cli):
        ...
        # Output Lines
        self.__output = [("SeRemoteShutdownPrivilege=")] + usernames
