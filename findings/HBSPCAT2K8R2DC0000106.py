...
class Finding:
    ...
    def get_rule_title(self):
        return r"Network Bridges will be prohibited in Windows."

    def get_vulnerability_discussion(self):
        return r"This check verifies the Network Bridge cannot be installed and configured. Set the policy value for Computer Configuration \ Administrative Templates \ Network \ Network Connections ?Prohibit installation and configuration of Network Bridge on your DNS domain network? to ?Enabled?."
