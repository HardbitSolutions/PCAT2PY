...
class Finding:
    ...
    def get_vulnerability_discussion(self):
        return r"This check verifies that Windows is configured to not limit access to CD drives when a user is logged on locally. Set the policy value for Computer Configuration \ Windows Settings \ Security Settings \ Local Policies \ Security Options \ ?Devices: Restrict CD-ROM access to locally logged-on user only? to ?Disabled?."
