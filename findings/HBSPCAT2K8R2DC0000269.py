...
class Finding:
    ...
    def get_rule_title(self):
        return r"The Teredo IPv6 transition technology will be disabled."

    def get_vulnerability_discussion(self):
        return r"IPv6 transition technologies which tunnel packets through other protocols do not provide visibility. Set the policy value for Computer Configuration \ Administrative Templates \ Network \ TCPIP Settings \ IPv6 Transition Technologies \ ?Teredo State? to ?Enabled: Disabled State?."
