...
class Finding:
    ...
    def get_rule_title(self):
        return r"The IE Trusted sites zone security parameter is set incorrectly."

    def get_vulnerability_discussion(self):
        return r"The Trusted sites zone must be set to custom level so the other required settings for the zone can take effect. Manipulate the value of registry HKCU\Software\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\2 to Currentlevel is 0"
    ...
    def check(self, cli):
        ...
        # Output Lines
        self.__output = [r'HKCU:\Software\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\2', ('Currrentlevel=' + str(dword))]
