...
class Finding:
    ...
    def get_vulnerability_discussion(self):
        return r"Removable hard drives, if they are not properly configured, can be formatted and ejected by users who are not members of the Administrators Group.  Formatting and ejecting removable NTFS media must only be done by administrators. Set the policy value for Computer Configuration \ Windows Settings \ Security Settings \ Local Policies \ Security Options \ ''Devices: Allowed to format and eject removable media'' to ''Administrators''."
