...
class Finding:
    ...
    def get_rule_title(self):
        return r"Unauthorized accounts must not have the Access Credential Manager as a trusted caller user right."

    def get_vulnerability_discussion(self):
        return r"Inappropriate granting of user rights can provide system, administrative, and other high-level capabilities.Accounts with the ''Access Credential Manager as a trusted caller'' user right may be able to retrieve the credentials of other accounts from Credential Manager. Set the policy value for Computer Configuration \ Windows Settings \ Security Settings \ Local Policies \ User Rights Assignment \ ''Access Credential Manager as a trusted caller'' to be defined but containing no entries (blank)."
