...
class Finding:
    ...
    def get_rule_title(self):
        return r"Configure IPv6 source routing to highest protection."

    def get_vulnerability_discussion(self):
        return r"This check verifies Windows is configured to protect against IPv6 packet spoofing. Set the policy value for ?MSS: (DisableIPSourceRouting IPv6) IP source routing protection level (protects against packet spoofing)? to ?Highest protection, source routing is completely disabled?."
