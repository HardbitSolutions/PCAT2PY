...
class Finding:
    ...
    def get_rule_title(self):
        return "The SSH daemon must not allow authentication using an empty password."
    
    def get_vulnerability_discussion(self):
        return "Configuring this setting for the SSH daemon provides additional assurance that remote login via SSH will require a password, even in the event of misconfiguration elsewhere."
