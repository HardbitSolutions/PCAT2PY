...
class Finding:
    ...
    def get_rule_title(self):
        return r"The system will be configured to disable the Internet Router Discover Protocol (IRDP)."

    def get_vulnerability_discussion(self):
        return r"Enables or disables the Internet Router Discovery Protocol (IRDP) used to detect and configure Default Gateway addresses on the computer. Set the policy value for Computer Configuration \ Windows Settings \ Security Settings \ Local Policies \ Security Options \ ?MSS: (PerformRouterDiscovery) Allow IRDP to detect and configure Default Gateway addresses (could lead to DoS)? to ?Disabled?."
