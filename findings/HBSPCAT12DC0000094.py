...
class Finding:
    ...
    def get_rule_title(self):
        return r"Network Bridges must be prohibited in Windows."

    def get_vulnerability_discussion(self):
        return r"A Network Bridge can connect two or more network segments, allowing unauthorized access or exposure of sensitive data.  This setting prevents a Network Bridge from being installed and configured. Set the policy value for Computer Configuration \ Administrative Templates \ Network \ Network Connections \ ''Prohibit installation and configuration of Network Bridge on your DNS domain network'' to ''Enabled''."
