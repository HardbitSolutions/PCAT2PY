...
class Finding:
    ...
    def get_vulnerability_discussion(self):
        return r"Microsoft ActiveX controls and file downloads often have digital signatures attached that vouch for both the file''s integrity and the identity of the signer (creator) of the software. Such signatures help ensure that unmodified. Manipulate the value: HKLM\Software\Policies\Microsoft\Internet Explorer\DownloadCriteria: Set the value RunInvalidSignatures to REG_DWORD = 0."
