...
class Finding:
    ...
    def get_rule_title(self):
        return r"Turn on Cross-Site Scripting (XSS) Filter property is properly set (Restricted Sites Zone)."

    def get_vulnerability_discussion(self):
        return r"This setting controls if the Cross-Site Scripting (XSS) Filter detects and prevents cross-site script injection into Web sites in this zone. Manipulate the value: HKLM\Software\Policies\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\4 Criteria: Set the value 1409 to REG_DWORD = 0."
