...
class Finding:
    ...
    def get_rule_title(self):
        return r"The IE SSL/TLS parameter is not set correctly."

    def get_vulnerability_discussion(self):
        return r"This parameter ensures SSL and TLS are able to be used from the browser. Manipulate the value HKCU\Software\Microsoft\Windows\CurrentVersion\Internet Settings so that value SecureProtocols is A0."
