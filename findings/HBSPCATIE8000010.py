...
class Finding:
    ...
    def get_rule_title(self):
        return r"The Java Permissions is not set properly for the Internet Zone."

    def get_vulnerability_discussion(self):
        return r"Java must have levels of protection based upon the site being browsed. Manipulate the registry key to read as follows: HKLM:\Software\Policies\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\3 Criteria: Set the value 1C00 to REG_DWORD = 0 (Disabled = 0)."
