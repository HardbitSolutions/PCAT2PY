...
class Finding:
    ...
    def get_rule_title(self):
        return r"Unauthorized accounts will not have the ''Access this computer from the network'' user right."

    def get_vulnerability_discussion(self):
        return r"Inappropriate granting of user rights can provide system, administrative, and other high level capabilities.Accounts with the ''Access this computer from the network'' right may access resources on the system and should be limited to those requiring it. Set the policy value for Computer Configuration \ Windows Settings \ Security Settings \ Local Policies \ User Rights Assignment \ ''Access this computer from the network'' as defined."
