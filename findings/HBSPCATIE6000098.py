...
class Finding:
    ...
    def get_rule_title(self):
        return r"Internet Explorer is not configured to disable making Proxy Settings Per Machine."

    def get_vulnerability_discussion(self):
        return r"This setting controls whether or not the Internet Explorer proxy settings are configured on a per-user or per-machine basis. Manipulate the value: HKLM\Software\Policies\Microsoft\Windows\CurrentVersion\Internet Settings\Criteria: Set the value ProxySettingsPerUser to REG_DWORD = 1."
