...
class Finding:
    ...
    def get_vulnerability_discussion(self):
        return r"Any nodes? interface with IPv6 enabled by default presents a potential risk of traffic being transmitted or received without proper risk mitigation strategy and is, therefore, a serious security concern. To disable IPv6 on all interfaces, Set the following registry key:Registry Hive: HKEY_LOCAL_MACHINESubkey: System\CurrentControlSet\Services\Tcpip6\ParametersValue Name: DisabledComponentsType: REG_DWORDValue: 0xffffffff"
