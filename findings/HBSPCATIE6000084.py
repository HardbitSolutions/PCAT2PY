...
class Finding:
    ...
    def get_rule_title(self):
        return r"The Scripting of Java applets is not set properly for the Restricted Sites Zone."

    def get_vulnerability_discussion(self):
        return r"The Scripting of Java applets must have level of protection based upon the site being accessed. Manipulate the value: HKLM\Software\Policies\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\4 Criteria: Set the value 1402 to REG_DWORD = 3 (Disabled = 3)."
