...
class Finding:
    ...
    def get_rule_title(self):
        return r"Download signed ActiveX controls for restricted sites zone is not disabled."

    def get_vulnerability_discussion(self):
        return r"ActiveX controls can contain potentially malicious code and must only be allowed to be downloaded from  trusted sites. Manipulate the value: HKLM\Software\Policies\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\4Criteria: Set the value 1001 to REG_DWORD = 3."
