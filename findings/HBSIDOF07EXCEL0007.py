...
class Finding:
    ...
    def get_rule_title(self):
        return r"Block opening of pre-release versions of file formats new to Excel  2007 through the Compatibility Pack for the 2007 Office system and Excel 2007 Converter - System"
    ...
    def check(self, cli):
        ...
        # Output Lines
        self.__output = [r'HKCU:\Software\Policies\Microsoft\Office\12.0\Excel\Security\FileOpenBlock', ('Excel12BetaFilesFromConverters=' + str(dword))]
