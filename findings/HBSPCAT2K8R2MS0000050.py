...
class Finding:
    ...
    def get_rule_title(self):
        return r"The Recovery Console SET command will be disabled."

    def get_vulnerability_discussion(self):
        return r"Enabling this option enables the Recovery Console SET command, which allows you to set Recovery Console environment variables.  This permits floppy copy and access to all drives and folders. Set the policy value for Computer Configuration \ Windows Settings \ Security Settings \ Local Policies \ Security Options \ ?Recovery Console: Allow floppy copy and access to all drives and folders? to ?Disabled?."
