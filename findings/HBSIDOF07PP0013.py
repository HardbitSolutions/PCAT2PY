...
class Finding:
    ...
    def get_rule_title(self):
        return r"Block opening of pre-release versions of file formats new to PowerPoint 2007 through the Compatibility Pack for the 2007 Office system and PowerPoint 2007 Converter - System"
    ...
    def check(self, cli):
        ...
        # Output Lines
        self.__output = [r'HKCU:\Software\Policies\Microsoft\Office\12.0\PowerPoint\Security\FileOpenBlock', ('PowerPoint12BetaFilesFromConverters=' + str(dword))]
