...
class Finding:
    ...
    def check(self, cli):
        ...
        # Output Lines
        self.__output = [r'HKCU:\software\policies\Microsoft\office\15.0\common\toolbars\outlook', ('NoExtensibilityCustomizationFromDocument=' + str(dword))]
