...
class Finding:
    ...
    def get_rule_title(self):
        return r"Ejection of removable NTFS media must be restricted to Administrators."

    def get_vulnerability_discussion(self):
        return r"Removable hard drives can be formatted and ejected by others who are not members of the Administrators Group, if they are not properly configured.  Formatting and ejecting removable NTFS media must only be done by administrators. Set the policy value for Computer Configuration \ Windows Settings \ Security Settings \ Local Policies \ Security Options \ ''Devices: Allowed to Format and Eject Removable Media'' to ''Administrators''."
