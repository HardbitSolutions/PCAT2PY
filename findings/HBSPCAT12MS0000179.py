...
class Finding:
    ...
    def get_rule_title(self):
        return r"All Direct Access traffic must be routed through the internal network."

    def get_vulnerability_discussion(self):
        return r"Routing all Direct Access  traffic through the internal network allows monitoring and prevents split tunneling. Set the policy value for Computer Configuration \ Administrative Templates \ Network \ Network Connections \ ''Route all traffic through the internal network'' to ''Enabled: Enabled State''."
