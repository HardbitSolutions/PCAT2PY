...
class Finding:
    ...
    def get_rule_title(self):
        return r"The Recovery Console option must be set to prevent automatic logon to the system."

    def get_vulnerability_discussion(self):
        return r"If this option is enabled, the Recovery Console does not require a password and automatically logs on to the system.  This could allow unauthorized administrative access to the system. Set the policy value for Computer Configuration \ Windows Settings \ Security Settings \ Local Policies \ Security Options \ ''Recovery console: Allow automatic administrative logon'' to ''Disabled''."
