...
class Finding:
    ...
    def get_rule_title(self):
        return r"The Download signed ActiveX controls property is not set properly for the Restricted Sites Zone."

    def get_vulnerability_discussion(self):
        return r"ActiveX controls can contain potentially malicious code and must only be allowed to be downloaded from  trusted sites. Manipulate the registry key to read as follows: HKLM:\Software\Policies\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\4Criteria: If the value 1001 is REG_DWORD = 3 (Disabled = 3)."
