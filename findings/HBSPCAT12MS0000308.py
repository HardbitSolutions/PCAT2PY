...
class Finding:
    ...
    def get_rule_title(self):
        return r"The system must be configured to prevent unsolicited remote assistance offers."

    def get_vulnerability_discussion(self):
        return r"Remote assistance allows another user to view or take control of the local session of a user.  Unsolicited remote assistance is help that is offered by the remote user.  This may allow unauthorized parties access to the resources on the computer. Set the policy value for Computer Configuration \ Administrative Templates \ System \ Remote Assistance \ ''Configure Offer Remote Assistance'' to ''Disabled''."
