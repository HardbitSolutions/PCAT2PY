...
class Finding:
    ...
    def get_rule_title(self):
        return r"The Application Compatibility Program Inventory will be prevented from collecting data and sending the information to Microsoft."

    def get_vulnerability_discussion(self):
        return r"This setting will prevent the Program Inventory from collecting data about a system and sending the information to Microsoft. Set the policy value for Computer Configuration \ Administrative Templates \ Windows Components \ Application Compatibility \ ?Turn off Program Inventory? to ?Enabled?."
