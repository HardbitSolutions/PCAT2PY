...
class Finding:
    ...
    def get_rule_title(self):
        return r"The IE Local zone includes parameter is not set correctly."

    def get_vulnerability_discussion(self):
        return r"This parameter controls which sites are by default in the local zone.  Since this is the least restrictive zone these settings ensure that sites are not included in this zone by default. Manipulate the value of registry key HKCU\Software\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\1 to Flags is 0x43."
    ...
    def check(self, cli):
        ...
        # Output Lines
        self.__output = [r'HKCU:\Software\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\1', ('Flags=' + str(dword))]
