...
class Finding:
    ...
    def get_rule_title(self):
        return r"Audit policy using subcategories will be enabled."

    def get_vulnerability_discussion(self):
        return r"This policy setting allows administrators to enable the more precise auditing capabilities present in Windows Vista and 2008 forward. Set the policy value for Computer Configuration \ Windows Settings \ Security Settings \ Local Policies \ Security Options \ ?Audit: Force audit policy subcategory settings (Windows Vista or later) to override audit policy category settings? to ?Enabled?."
