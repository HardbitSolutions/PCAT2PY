...
class Finding:
    ...
    def get_rule_title(self):
        return r"The Cipher setting for Triple DES is not set properly."

    def get_vulnerability_discussion(self):
        return r"This enables the Triple Des cipher. Manipulate the registry key HKLM\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Ciphers\Triple DES 168/168 andManipulate the value to Enabled is 0xffffffff."
    ...
    def check(self, cli):
        ...
        # Output Lines
        self.__output = [r'HKLM:\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Ciphers\Triple DES 168', ('Enabled=' + str(dword))]
