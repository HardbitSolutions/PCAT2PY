...
class Finding:
    ...
    def get_rule_title(self):
        return r"The Internet Connection Wizard will not download a list of Internet Service Providers (ISPs) from Microsoft."

    def get_vulnerability_discussion(self):
        return r"This check verifies that the Internet Connection Wizard cannot download a list of Internet Service Providers (ISPs) from Microsoft. Set the policy value for Computer Configuration \ Administrative Templates \ System \ Internet Communication Management \ Internet Communication settings ?Turn off Internet Connection Wizard if URL connection is referring to Microsoft.com? to ?Enabled?."
