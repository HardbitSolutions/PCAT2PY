...
class Finding:
    ...
    def get_vulnerability_discussion(self):
        return r"Userdata persistence must have level of protection based upon the site being accessed. Manipulate the registry key to read as follows: HKLM:\Software\Policies\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\3Criteria: Set the value 1606 to REG_DWORD = 3 (Disabled = 3)."
