...
class Finding:
    ...
    def get_rule_title(self):
        return r"A system restore point will be created when a new device driver is installed."

    def get_vulnerability_discussion(self):
        return r"This check verifies that a system restore point will be created when a new device driver is installed. Set the policy value for Computer Configuration \ Administrative Templates \ System \ Device Installation ?Prevent creation of a system restore point during device activity that would normally prompt creation of a restore point? to ?Disabled?."
