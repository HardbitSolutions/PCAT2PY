...
class Finding:
    ...
    def get_vulnerability_discussion(self):
        return r"Java must have level of protections based upon the site being browsed. Manipulate the registry key to read as follows: HKLM:\Software\Policies\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\3Criteria: Set the value 1C00 to REG_DWORD = 0 (Disabled = 0)."
