...
class Finding:
    ...
    def get_rule_title(self):
        return r"Unauthorized accounts must not have the Back up files and directories user right."

    def get_vulnerability_discussion(self):
        return r"Inappropriate granting of user rights can provide system, administrative, and other high-level capabilities.Accounts with the ''Back up files and directories'' user right can circumvent file and directory permissions and could allow access to sensitive data. Set the policy value for Computer Configuration \ Windows Settings \ Security Settings \ Local Policies \ User Rights Assignment \ ''Back up files and directories'' to only include the following accounts or groups:Administrators"
    ...
    def check(self, cli):
        ...
        # Output Lines
        self.__output = [("SeBackupPrivilege=")] + usernames
