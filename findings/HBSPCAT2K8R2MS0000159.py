...
class Finding:
    ...
    def get_rule_title(self):
        return r"Services using Local System that use negotiate when reverting to NTLM authentication will use the computer identity vs. authenticating anonymously."

    def get_vulnerability_discussion(self):
        return r"This setting ensures that services using Local System that use negotiate when reverting to NTLM authentication will use the computer identity vs. authenticating anonymously. Set the policy value for Computer Configuration \ Windows Settings \ Security Settings \ Local Policies \ Security Options \ ?Network Security: Allow Local System to use computer identity for NTLM? to ?Enabled?."
