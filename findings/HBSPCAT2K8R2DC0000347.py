...
class Finding:
    ...
    def get_rule_title(self):
        return r"The system will be configured to prevent IP source routing."

    def get_vulnerability_discussion(self):
        return r"Protects against IP source routing spoofing. Set the policy value for Computer Configuration \ Windows Settings \ Security Settings \ Local Policies \ Security Options \ ?MSS: (DisableIPSourceRouting) IP source routing protection level (protects against packet spoofing)? to ?Highest protection, source routing is completely disabled?."
