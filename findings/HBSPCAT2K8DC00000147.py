...
class Finding:
    ...
    def get_rule_title(self):
        return r"Online Assistance ? Untrusted Content"

    def get_vulnerability_discussion(self):
        return r"This check verifies that untrusted content is not rendered for online assistance. Set the policy value for Computer Configuration \ Administrative Templates \ Windows Components \ Online Assistance ?Turn off Untrusted Content? to ?Enabled?."
    ...
    def check(self, cli):
        ...
        # Output Lines
        self.__output = [r'HKLM:\Software\Policies\Microsoft\Assistance\Client\1.0', ('NoUntrustedContent=' + str(dword))]
