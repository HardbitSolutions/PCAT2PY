...
class Finding:
    ...
    def get_rule_title(self):
        return r"Unauthorized accounts must not have the Change the time zone user right."

    def get_vulnerability_discussion(self):
        return r"Inappropriate granting of user rights can provide system, administrative, and other high level capabilities.Accounts with the ''Change the time zone'' user right can change the time zone of a system. Set the policy value for Computer Configuration \ Windows Settings \ Security Settings \ Local Policies \ User Rights Assignment \ ''Change the time zone'' to only include the following accounts or groups:AdministratorsUsersLocal Service"
    ...
    def check(self, cli):
        ...
        # Output Lines
        self.__output = [("SeTimeZonePrivilege=")] + usernames
