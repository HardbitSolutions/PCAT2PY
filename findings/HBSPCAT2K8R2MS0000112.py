...
class Finding:
    ...
    def get_rule_title(self):
        return r"Users will not be presented with Privacy and Installation options on first use of Windows Media Player."

    def get_vulnerability_discussion(self):
        return r"This check verifies that users are not presented with Privacy and Installation options on first use of Windows Media Player. Set the policy value for Computer Configuration \ Administrative Templates \ Windows Components \ Windows Media Player ?Do Not Show First Use Dialog Boxes? to ?Enabled?."
