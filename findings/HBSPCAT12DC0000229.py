...
class Finding:
    ...
    def get_rule_title(self):
        return r"Unauthorized accounts must not have the Increase a process working set user right."

    def get_vulnerability_discussion(self):
        return r"Inappropriate granting of user rights can provide system, administrative, and other high-level capabilities.Accounts with the ''Increase a process working set'' user right can change the size of a process''s working set, potentially causing performance issues or a DoS. Set the policy value for Computer Configuration \ Windows Settings \ Security Settings \ Local Policies \ User Rights Assignment \ ''Increase a process working set'' to only include the following accounts or groups:AdministratorsLocal ServiceWindow Manager\Window Manager Group"
    ...
    def check(self, cli):
        ...
        # Output Lines
        self.__output = [("SeIncreaseWorkingSetPrivilege=")] + usernames
