...
class Finding:
    ...
    def get_rule_title(self):
        return r"The access control permissions for the Domain and OU group policy must be configured to use the required access permissions."
