...
class Finding:
    ...
    def get_rule_title(self):
        return r"Internet Explorer Processes Restrict ActiveX Install (Reserved) property is properly set."

    def get_vulnerability_discussion(self):
        return r"This policy setting enables blocking of ActiveX control installation prompts for Internet Explorer processes.  If you do not configure this policy setting, the user?s preference will be used to determine whether to block ActiveX control installations for Internet Explorer processes. Manipulate the value: HKLM\Software\Policies\Microsoft\Internet Explorer\Main\FeatureControl\FEATURE_RESTRICT_ACTIVEXINSTALL  Criteria: Set the value (Reserved) to REG_SZ = 1."
    ...
    def check(self, cli):
        ...
        # Output Lines
        self.__output = [r'HKLM:\Software\Policies\Microsoft\Internet Explorer\Main\FeatureControl\FEATURE_RESTRICT_ACTIVEXINSTALL', ('(Reserved)=' + sz)]
