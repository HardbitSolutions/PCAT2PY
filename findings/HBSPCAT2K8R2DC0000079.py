...
class Finding:
    ...
    def get_rule_title(self):
        return r"The system will require username and password to elevate a running application."

    def get_vulnerability_discussion(self):
        return r"This check verifies that the system is configured to always require a user to type in a user name and password to elevate a running application. Set the policy value for Computer Configuration \ Administrative Templates \ Windows Components \ Credential User Interface ?Enumerate administrator accounts on elevation? to ?Disabled?."
