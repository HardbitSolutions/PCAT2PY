...
class Finding:
    ...
    def get_vulnerability_discussion(self):
        return r"Allowing ICMP redirect of routes can lead to traffic not being routed properly.   When disabled, this forces ICMP to be routed via shortest path first. Set the policy value for Computer Configuration \ Windows Settings \ Security Settings \ Local Policies \ Security Options \ ''MSS: (EnableICMPRedirect) Allow ICMP redirects to override OSPF generated routes'' to ''Disabled''."
