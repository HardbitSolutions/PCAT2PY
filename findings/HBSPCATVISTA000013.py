...
class Finding:
    ...
    def get_vulnerability_discussion(self):
        return r"This check verifies that Windows is configured to not limit access to floppy drives when a user is logged on locally per the FDCC. Set the policy value for Computer Configuration \ Windows Settings \ Security Settings \ Local Policies \ Security Options \ ?Devices: Restrict floppy access to locally logged-on user only? to ?Disabled?."
    ...
    def get_hbs_id(self):
        return "HBSPCATVISTA000013"
    
    def get_dod8500_2(self):
        return "ECLP-1, ECSC-1"

    def get_800_53(self):
        return "AC-5, AC-6, AC-6(2), CM-6"
    
    def get_iso_27001(self):
        return "A.10.1.3, A.11.2.2, A.11.4.1, A.11.4.4, A.11.5.4, A.11.6.1, A.12.4.3, A.10.10.2"