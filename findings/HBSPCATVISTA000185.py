...
class Finding:
    ...
    def get_rule_title(self):
        return r"The Deny log on through Terminal Services user right on workstations must prevent all access if RDS is not used by the organization.  If TS is used, it must be configured to prevent access from highly privileged domain accounts and local administrator accounts on domain systems and unauthenticated access on all systems."
