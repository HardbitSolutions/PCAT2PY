...
# 09/03/2014 Added -type f into find commands to omit links
################################################################################
...
class Finding:
    ...
    def get_rule_title(self):
        return "All system command files must have mode 0755 or less permissive."
    
    def get_vulnerability_discussion(self):
        return "System binaries are executed by privileged users, as well as system services, and restrictive permissions are necessary to ensure execution of these programs cannot be co-opted."
