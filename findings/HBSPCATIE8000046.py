...
class Finding:
    ...
    def get_rule_title(self):
        return r"Turn off the Security Settings Check feature is not disabled."

    def get_vulnerability_discussion(self):
        return r"This policy setting turns off the Security Settings Check feature, which checks Internet Explorer security settings to determine when the settings put Internet Explorer at risk.  If you enable this policy setting, the security settings check will not be performed.  If you disable or do not configure this policy setting, the security settings check will be performed. Manipulate the value: HKLM\Software\Policies\Microsoft\Internet Explorer\Security Criteria: Set the value DisableSecuritySettingsCheck to REG_DWORD = 0."
