...
class Finding:
    ...
    def get_rule_title(self):
        return r"The Windows Connect Now wizards will be disabled."

    def get_vulnerability_discussion(self):
        return r"This check verifies that access to the Windows Connect Now wizards is disabled. Set the policy value for Computer Configuration \ Administrative Templates \ Network \ Windows Connect Now ?Prohibit Access of the Windows Connect Now wizards? to ?Enabled?."
