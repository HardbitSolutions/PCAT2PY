...
class Finding:
    ...
    def get_hippa(self):
        return "164.308(a)(3)(i),164.308(a)(4)(i),164.308(a)(4)(ii)(A),164.312(a)(1)"
    
    def get_pci(self):
        return "7.1.2,7.1.3"
    
    def get_hbs_id(self):
        return "HBSPCAT2K8R2DC0000378"
