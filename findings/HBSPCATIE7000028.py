...
class Finding:
    ...
    def get_rule_title(self):
        return r"Allow font downloads for restricted sites zone is not disabled."

    def get_vulnerability_discussion(self):
        return r"Download of fonts can sometimes contain malicious code.    Files should not be downloaded from restricted sites. Manipulate the value: HKLM\Software\Policies\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\4Criteria: Set the value 1604 to REG_DWORD = 3."
