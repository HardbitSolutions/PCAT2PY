...
class Finding:
    ...
    def get_vulnerability_discussion(self):
        return r"Remote connections must be encrypted to prevent interception of data or sensitive information.  Selecting ?High Level? will ensure encryption of Terminal Services sessions in both directions. 2008 - Set the policy value for Computer Configuration \ Administrative Templates \ Windows Components \ Terminal Services \Terminal Server \ Security ?Set Client Connection Encryption Level? will be set to ?Enabled? and select ?High Level? for the ?Encryption Level?."
