...
class Finding:
    ...
    def check(self, cli):
        ...
        # Output Lines
        self.__output = [r'HKCU:\Software\Policies\Microsoft\Office\14.0\access\security', ('RequireAddinSig=' + str(dword))]
