...
class Finding:
    ...
    def get_rule_title(self):
        return r"Windows Explorer ? Shell Protocol Protected Mode"

    def get_vulnerability_discussion(self):
        return r"This check verifies that the shell protocol is run in protected mode.  (This allows applications to only open limited folders.) Set the policy value for Computer Configuration \ Administrative Templates \ Windows Components \ Windows Explorer ?Turn off shell protocol protected mode? to ?Disabled?."
