...
class Finding:
    ...
    def get_rule_title(self):
        return r"The built-in administrator account must be renamed."

    def get_vulnerability_discussion(self):
        return r"The built-in administrator account is a well-known account subject to attack.  Renaming this account to an unidentified name improves the protection of this account and the system. Set the policy value for Computer Configuration \ Windows Settings \ Security Settings \ Local Policies \ Security Options \ ''Accounts: Rename administrator account'' to a name other than ''Administrator''."
