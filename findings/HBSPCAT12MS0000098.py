...
class Finding:
    ...
    def get_rule_title(self):
        return r"Users must be prevented from changing installation options."

    def get_vulnerability_discussion(self):
        return r"Installation options for applications are typically controlled by administrators.  This setting prevents users from changing installation options that may bypass security features. Set the policy value for Computer Configuration \ Administrative Templates \ Windows Components \ Windows Installer \ ''Allow user control over installs'' to ''Disabled''."
