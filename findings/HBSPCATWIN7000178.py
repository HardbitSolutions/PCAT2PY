...
class Finding:
    ...
    def get_rule_title(self):
        return r"Prevent the Application Compatibility Program Inventory from collecting data and sending the information to Microsoft."
