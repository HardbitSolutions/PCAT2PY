...
class Finding:
    ...
    def get_rule_title(self):
        return r"Remote Desktop Services will be configured with the client connection encryption set to the required level."

    def get_vulnerability_discussion(self):
        return r"Remote connections must be encrypted to prevent interception of data or sensitive information.  Selecting ?High Level? will ensure encryption of Remote Desktop Services sessions in both directions. Set the policy value for Computer Configuration \ Administrative Templates \ Windows Components \ Remote Desktop Services \ Remote Desktop Session Host \ Security ?Set client connection encryption level? to ?Enabled? and ?High Level?."
