...
class Finding:
    ...
    def get_rule_title(self):
        return r"The system must be configured to prevent automatic forwarding of error information."

    def get_vulnerability_discussion(self):
        return r"This setting controls the reporting of errors to Microsoft and, if defined, a corporate error reporting site.  This does not interfere with the reporting of errors to the local user.  Since the contents of memory are included in this error report, sensitive information may be transmitted to Microsoft.  This feature must be disabled to prevent the release of such information. Set the policy value for Computer Configuration \ Administrative Templates \ System \ Internet Communication Management \ Internet Communication settings \ ''Turn off Windows Error Reporting'' to ''Enabled''."
