...
class Finding:
    ...
    def get_rule_title(self):
        return r"The Access data sources across domains is not set properly for the Internet Zone."

    def get_vulnerability_discussion(self):
        return r"Access to data sources across multiple domains must be controlled based upon the site being browsed. Manipulate the registry key to read as follows: HKLM:\Software\Policies\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\3 Criteria: Set the value 1406 to REG_DWORD = 3 (Disabled = 3)."
