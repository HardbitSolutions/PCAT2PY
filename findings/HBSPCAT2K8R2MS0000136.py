...
class Finding:
    ...
    def get_rule_title(self):
        return r"Windows Defender SpyNet membership will be disabled."

    def get_vulnerability_discussion(self):
        return r"This check verifies that SpyNet membership is disabled. Set the policy value for Computer Configuration \ Administrative Templates \ Windows Components \ Windows Defender ?Configure Microsoft Spynet Reporting? to ?Disabled?."
