...
class Finding:
    ...
    def get_rule_title(self):
        return r"The Navigate windows and frames across different domains are not set properly for the Restricted Sites Zone."

    def get_vulnerability_discussion(self):
        return r"Frames that navigate across different domains are a security concern, because users may think they are accessing pages on one site while they are actually accessing pages on another site. Manipulate the registry key to read as follows: HKLM:\Software\Policies\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\4 Criteria: Set the value 1607 to REG_DWORD = 3 (Disabled = 3)."
