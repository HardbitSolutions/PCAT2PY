...
class Finding:
    ...
    def get_rule_title(self):
        return r"The system must be configured to require case insensitivity for non-Windows subsystems."

    def get_vulnerability_discussion(self):
        return r"This setting controls the behavior of non-Windows subsystems when dealing with the case of arguments or commands.  Case sensitivity could lead to the access of files or commands that must be restricted.  To prevent this from happening, case insensitivity restrictions must be required. Set the policy value for Computer Configuration \ Windows Settings \ Security Settings \ Local Policies \ Security Options \ ''System objects: Require case insensitivity for non-Windows subsystems'' to ''Enabled''."
