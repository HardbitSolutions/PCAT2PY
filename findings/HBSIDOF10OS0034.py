...
class Finding:
    ...
    def get_rule_title(self):
        return r"Office Live Workspace Integration must be off."

    def get_vulnerability_discussion(self):
        return r"This setting controls the exposing of entry points for Office Live Workspace Integration features. Set the policy value for: User Configuration \ Administrative Templates \ Microsoft Office 2010 \ Office Live Workspace ?Turn Off Office Live Workspace Integration? to ?Enabled?."
    ...
    def check(self, cli):
        ...
        # Output Lines
        self.__output = [r'HKCU:\Software\Policies\Microsoft\Office\14.0\common\officeliveworkspace', ('TurnOffOfficeLiveWorkspaceIntegration=' + str(dword))]
