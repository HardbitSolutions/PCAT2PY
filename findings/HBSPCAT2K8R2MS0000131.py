...
class Finding:
    ...
    def get_rule_title(self):
        return r"Errors in handwriting recognition on Tablet PCs will not be reported to Microsoft."

    def get_vulnerability_discussion(self):
        return r"This check verifies that errors in handwriting recognition on Tablet PCs are not reported to Microsoft. Set the policy value for Computer Configuration \ Administrative Templates \ System \ Internet Communication Management \ Internet Communications settings ?Turn off handwriting recognition error reporting? to ?Enabled?."
