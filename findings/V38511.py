...
class Finding:
    ...
    def get_rule_title(self):
        return "IP forwarding for IPv4 must not be enabled, unless the system is a router."
    
    def get_vulnerability_discussion(self):
        return "IP forwarding permits the kernel to forward packets from one network interface to another. The ability to forward packets between two networks is only appropriate for routers."
