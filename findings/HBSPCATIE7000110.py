...
class Finding:
    ...
    def get_vulnerability_discussion(self):
        return r"This AutoComplete feature can remember and suggest User names and passwords on Forms.  If you enable this setting, the user cannot change ''User name and passwords on forms'' or ''prompt me to save passwords''. The Auto Complete feature for User names and passwords on Forms will be turned on. You have to decide whether to select ''prompt me to save passwords''.  If you disable this setting the user cannot change ''User name and passwords on forms'' or ''prompt me to save passwords''. The Auto Complete feature for User names and passwords on Forms is turned off. The user also cannot opt to be prompted to save passwords.  If you do not configure this setting, the user has the freedom of turning on Auto complete for User name and passwords on forms and the option of prompting to save passwords. To display this option, the users open the Internet Options dialog box, click the Contents Tab and click the Settings button. Manipulate the value: HKCU\Software\Policies\Microsoft\Internet Explorer\MainCriteria: Set the value FormSuggest Passwords to REG_SZ = no.HKCU\Software\Policies\Microsoft\Internet Explorer\Control PanelCriteria: Set the value FormSuggest Passwords to REG_DWORD = 1."
    ...
    def check(self, cli):
        ...
        # Output Lines
        self.__output = [r'HKCU:\Software\Policies\Microsoft\Internet Explorer\Control Panel', ('FormSuggest Passwords=' + str(dword))]
