...
class Finding:
    ...
    def get_rule_title(self):
        return r"The prompt to display level 1 attachments must be disallowed when closing an item."
    ...
    def check(self, cli):
        ...
        # Output Lines
        self.__output = [r'HKCU:\Software\Policies\Microsoft\Office\15.0\outlook\security', ('DontPromptLevel1AttachClose=' + str(dword))]
