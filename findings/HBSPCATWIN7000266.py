...
class Finding:
    ...
    def get_rule_title(self):
        return r"Unauthorized users will not have the ''Log on as a service'' User Right."

    def get_vulnerability_discussion(self):
        return r"Inappropriate granting of user rights can provide system, administrative, and other high level capabilities.Accounts with the right ''Log on as a service'' can start network services or register a process as a service on the system. Set the policy value for Computer Configuration \ Windows Settings \ Security Settings \ Local Policies \ User Rights Assignment \ ''Log on as a service'' as defined."
