...
class Finding:
    ...
    def check(self, cli):
        ...
        # Output Lines
        self.__output = [r'HKCU:\Software\Policies\Microsoft\office\15.0\excel\security\fileblock', ('XL9597WorkbooksandTemplates=' + str(dword))]
