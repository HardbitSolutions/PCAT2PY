...
class Finding:
    ...
    def get_rule_title(self):
        return r"A password will be required on resume from hibernate/suspend."

    def get_vulnerability_discussion(self):
        return r"This check verifies that the user is prompted for a password on resume from hibernate/suspend. Set the policy value for User Configuration \ Administrative Templates \ System \Power Management \ ?Prompt for password on resume from hibernate/suspend? to ?Enabled?."
    ...
    def check(self, cli):
        ...
        # Output Lines
        self.__output = [r'HKCU:\Software\Policies\Microsoft\Windows\System\Power', ('PromptPasswordOnResume=' + str(dword))]
