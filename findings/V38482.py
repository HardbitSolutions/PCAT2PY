...
class Finding:
    ...
    def get_rule_title(self):
        return "The system must require passwords to contain at least one numeric character."
    
    def get_vulnerability_discussion(self):
        return "Requiring digits makes password guessing attacks more difficult by ensuring a larger search space."
