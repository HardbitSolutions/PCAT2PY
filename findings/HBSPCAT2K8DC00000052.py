...
class Finding:
    ...
    def get_vulnerability_discussion(self):
        return r"By default, the print spooler allows any user to add and to delete printer drivers on the local system.  This capability should be restricted to authorized personnel. Set the policy value for Computer Configuration \ Windows Settings \ Security Settings \ Local Policies \ Security Options \ ?Devices: Prevent users from installing printer drivers? to ?Enabled?."
