...
class Finding:
    ...
    def get_rule_title(self):
        return r"The system will be configured to require a strong session key."

    def get_vulnerability_discussion(self):
        return r"This setting controls the required strength of a session key. Set the policy value for Computer Configuration \ Windows Settings \ Security Settings \ Local Policies \ Security Options \ ?Domain Member: Require Strong (Windows 2000 or Later) Session Key? to ?Enabled?."
