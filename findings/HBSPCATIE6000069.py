...
class Finding:
    ...
    def get_vulnerability_discussion(self):
        return r"Download of fonts can sometimes contain malicious code.    Files should not be downloaded from restricted sites. Manipulate the registry key to read as follows: HKLM:\Software\Policies\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\4Criteria: If the value 1604 is REG_DWORD = 3 (Disabled = 3)."
