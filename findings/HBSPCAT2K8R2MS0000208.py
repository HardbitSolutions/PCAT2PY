...
class Finding:
    ...
    def get_rule_title(self):
        return r"Unauthorized accounts will not have the ''Increase scheduling priority'' user right."

    def get_vulnerability_discussion(self):
        return r"Inappropriate granting of user rights can provide system, administrative, and other high level capabilities.Accounts with the ''Increase scheduling priority'' right can change a scheduling priority causing performance issues or a DoS. Set the policy value for Computer Configuration \ Windows Settings \ Security Settings \ Local Policies \ User Rights Assignment \ ''Increase scheduling priority'' as defined."
